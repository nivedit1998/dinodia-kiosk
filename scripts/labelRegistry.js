...
const root = path.resolve(__dirname, '..'); // kiosk root
const platformRoot = path.resolve(root, '..', 'dinodia-platform');
const canonicalPath = path.join(platformRoot, 'labels', 'registry.json');

const targets = [
  {
    name: 'platform',
    path: path.join(platformRoot, 'src', 'config', 'labelRegistry.json'),
    visualsPath: path.join(platformRoot, 'src', 'components', 'device', 'deviceVisuals.tsx'),
    capabilitiesPath: path.join(platformRoot, 'src', 'lib', 'deviceCapabilities.ts'),
    commandsHandlerPath: path.join(platformRoot, 'src', 'lib', 'deviceControl.ts'),
    capabilitiesSourcePath: path.join(platformRoot, 'src', 'lib', 'deviceCapabilities.ts'),
  },
  {
    name: 'kiosk',
    path: path.join(root, 'src', 'config', 'labelRegistry.json'),
    visualsPath: path.join(root, 'src', 'components', 'deviceVisuals.ts'),
    capabilitiesPath: null, // kiosk capabilities optional for parity check
    commandsHandlerPath: path.join(root, 'src', 'utils', 'haCommands.ts'),
    capabilitiesSourcePath: path.join(root, 'src', 'capabilities', 'deviceCapabilities.ts'),
  },
];
